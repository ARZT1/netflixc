...
const EditProfileModal = ({ onClose }) => {
  ...
  // Asumimos que podemos editar nombre/email u otros datos según el API
  ...
  const handleSubmit = (e) => {
    ...
    // Aquí idealmente haríamos un PATCH a /users/:id en la API de Mokky
    // Para el scope actual de la UI simularemos el éxito
