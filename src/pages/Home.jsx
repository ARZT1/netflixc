  ...
  return (
    <div className="min-h-screen bg-black text-white relative">
      <header className="absolute top-0 left-0 right-0 p-6 flex justify-between items-center z-50">
        <h1 className="text-red-600 text-3xl font-bold tracking-wider">Nextflix</h1>
        <button
      ...
      <section
        ...
        style={{
          backgroundImage: `url('https://www.peacocktv.com/dam/growth/assets/Collections/harry-potter/hp-franchise-social-2025.jpg')`,
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl mt-16">
          <h1 className="text-5xl md:text-6xl font-bold mb-4 drop-shadow-lg">
            Bienvenido a <span className="text-red-600">Nextflix</span>
          </h1>
